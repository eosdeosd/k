var rule = {
    ...
    lazy:'js:input={parse: 1, playUrl: "https://jx.lasi.fun/blue/index.php?url=", jx: 1, url: input.split("?")[0]}',
    multi: 1,
    timeout: 5000,
    limit: 6,
    url: '/api.php/provide/vod?ac=detail&t=fyclass&pg=fypage&f=',
    class_name: '国产剧&香港剧&台湾剧&韩国剧&日本剧&喜剧片&动作片&科幻片',
